...
function handleAuthorizeClick() {
  generateCodeChallenge(codeVerifier).then((codeChallenge) => {
    ...
    let scope =
      "user-library-read playlist-read-private playlist-read-collaborative user-read-email user-read-private user-read-recently-played user-read-currently-playing playlist-modify-public playlist-modify-private";
